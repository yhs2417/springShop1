...
<form action="" method="post" name="signUpForm">
    ...
    <fieldset class="form-group">
        <div class="row">
            ...
            <strong>ID</strong></legend>
            <div class="col-md-9 border-left">
                <div class="form-group">
                    <label for="userId">아이디</label>
              
                    <input type="text" class="form-control" id="userId" required 
                    		placeholder="영문자 ,숫자  4~14자" name="userId">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="userPwd"  required
                    		placeholder="특수문자 포함 8자이상" name="userPwd">
                    <div class="valid-feedback" >사용가능한 비밀번호입니다</div>
                    <div class="invalid-feedback">적절하지 않은 비밀번호입니다</div>
                </div>
                <div class="form-group">
                    <label for="userPwd2">암호확인</label>
                    <input type="password" class="form-control" id="userPwd2" required
                    		placeholder="특수문자 포함 8자이상" name="userPwd2">
    ...
    <fieldset class="form-group">
        <div class="row">
            <legend class="col-md-3 col-form-label pt-0 pr-5 text-right">
            	<strong>주소</strong></legend>
            <div class="col-md-9 border-left">
                <div class="form-group row">
         
                    <input type="text" class="form-control col-md-2 ml-3" placeholder="우편번호"
                    		id="addrNum" name="addrNum" readonly >	
                	 <button type="button" class="btn btn-white col-md-2 ml-2"
                	 		onclick="execPostCode();">우편번호검색</button>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="addr1" 
                    		readonly name="addr1" placeholder="기본주소">
                </div>
                <div class="form-group">
